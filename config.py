...
DB_URI = environ.get("DB_URI","mongodb+srv://shrivastavashubham300:<IrQfTNGtWR040GUV>@cluster0.niybv.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0") # Warning - Give Db uri in deploy server environment variable, don't give in repo.
